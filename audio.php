     ...
     <div class="indent">
      <div class="wrapper">
       <div class="wrapper_bottom">
        <div class="wrapper_top">
            <div class="col_1">
            	...
            	<select name="category" onchange="displayCategory(this.value);">
            	    ...
            	    <?php
            	        $query = mysql_query("select distinct category from media where path like '%.mp3' order by category"); 
	    ...
	    <h3 style="float:left;padding:5px"><img src="images/audio.png" alt="" /></h3> 
            <div class="all" style="margin-top:50px"> 
            <?php
    	        $queryMedia = mysql_query("select category, title, path from media where path like '%.mp3' order by title"); 
    	        $prev_category = "";
    	        echo "<div>";
    	        while ($resultsMedia = mysql_fetch_array($queryMedia)) {
                    ...
                    echo "<span style='white-space:nowrap;clear:both;float:left;'><a href='data/audio/{$path}'>{$title}</a></span><br />\n"; 
